...
class MatchObsAllQC(QMainWindow):
    ...
    def handleCellRightClick(self, item, fieldType):
        ...
        if status == "plain" or status == "unchanged":
            ...
            ignoreAllAction = QAction("Ignore all values for this station", self)
            ...
            # For ignoreall data
            cancelAction = QAction("Cancel ignore all", self)
